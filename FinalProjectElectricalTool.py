...
def main() -> None:
    ...
    def create_gui():
        ...
        def show_ohms_law():
            ...
            ttk.Radiobutton(ohms_window, text="Calculate Voltage (V = I × R)", variable=mode_var, value="voltage", command=lambda: update_fields()).pack(anchor="w", padx=20)
            ttk.Radiobutton(ohms_window, text="Calculate Current (I = V ÷ R)", variable=mode_var, value="current", command=lambda: update_fields()).pack(anchor="w", padx=20)
            ttk.Radiobutton(ohms_window, text="Calculate Resistance (R = V ÷ I)", variable=mode_var, value="resistance", command=lambda: update_fields()).pack(anchor="w", padx=20)
        ...
        def show_power_calculations():
            ...
            ttk.Radiobutton(power_window, text="P = V × I", variable=option_var, value="1", command=lambda: update_power_fields()).pack(anchor="w", padx=20)
            ttk.Radiobutton(power_window, text="P = I² × R", variable=option_var, value="2", command=lambda: update_power_fields()).pack(anchor="w", padx=20)
            ttk.Radiobutton(power_window, text="V = P ÷ I", variable=option_var, value="3", command=lambda: update_power_fields()).pack(anchor="w", padx=20)
            ttk.Radiobutton(power_window, text="I = P ÷ V", variable=option_var, value="4", command=lambda: update_power_fields()).pack(anchor="w", padx=20)
